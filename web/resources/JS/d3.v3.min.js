...
function dt(n,t,e,r){
    ...
    if(2===arguments.length&&"function"==typeof r&&(i=r,r=null),c.open(e,n,!0),null==t||"accept"in o||(o.accept=t+",*/*"),c.setRequestHeader)for(var a in o)c.setRequestHeader(a,o[a]);return null!=t&&c.overrideMimeType&&c.overrideMimeType(t),null!=l&&(c.responseType=l),null!=i&&u.on("error",i).on("load",function(n){
        i(null,n)
...
function Ut(){
    ...
    for(var s,f,h,g=u[0];;){
        for(s=g;s.visited;)if((s=s.next)===g)return;f=s.points,i.lineStart();
        do{
...
function Gt(n,t,e,r){
    ...
    function Kt(n,t,e,r){
    var i;
    if(null==n)i=e*Wa/2,r.point(-Wa,i),r.point(0,i),r.point(Wa,i),r.point(Wa,0),r.point(Wa,-i),r.point(0,-i),r.point(-Wa,-i),r.point(-Wa,0),r.point(-Wa,i);
    ...
    function t(n,t){
        ...
        return{
            ...
            point:function(f,h){
                ...
                if(!e&&(c=a=d)&&n.lineStart(),d!==a&&(g=r(e,p),(Ht(e,g)||Ht(p,g))&&(p[0]+=Ja,p[1]+=Ja,d=t(p[0],p[1]))),d!==a)s=0,d?(n.lineStart(),g=r(p,e),n.point(g[0],g[1])):(g=r(e,p),n.point(g[0],g[1]),n.lineEnd()),e=g;
                else if(l&&e&&o^d){
                    var v;
...
distance:function(n,t){
    ...
    nextEvent:function(n){
        for(var t=0,e=u.list,r=e.length;r>t;++t)if(e[t]==n)return e[t+1];return null
        },
    min:function(){
        var n=u.list[0];
        return{
...
function yr(n,t){
    ...
    for(e in n)e in t?r[e]=br(n[e],t[e]):i[e]=n[e];for(e in t)e in n||(i[e]=t[e]);return function(n){
...
function xr(n,t){
    ...
    for(o<t.length&&l.push(t.substring(o)),r=0,u=s.length;(e=hc.exec(n))&&u>r;++r)if(a=s[r],a.x==e[0]){
        if(a.i)if(null==l[a.i+1])for(l[a.i-1]+=a.x,l.splice(a.i,1),i=r+1;u>i;++i)s[i].i--;else for(l[a.i-1]+=a.x+l[a.i+1],l.splice(a.i,2),i=r+1;u>i;++i)s[i].i-=2;
        else if(null==l[a.i+1])l[a.i]=a.x;else for(l[a.i]=a.x+l[a.i+1],l.splice(a.i+1,1),i=r+1;u>i;++i)s[i].i--;
        s.splice(r,1),u--,r--
    }else a.x=Mr(parseFloat(e[0]),parseFloat(a.x));for(;u>r;)a=s.pop(),null==l[a.i+1]?l[a.i]=a.x:(l[a.i]=a.x+l[a.i+1],l.splice(a.i+1,1)),u--;
...
da.bisectLeft=Ea.left,da.bisect=da.bisectRight=Ea.right,da.shuffle=function(n){
    ...
    var t=[];
    for(var e in n)t.push(e);return t
    },da.values=function(n){
    var t=[];
    for(var e in n)t.push(n[e]);return t
    ...
    var t=new i;
    for(var e in n)t.set(e,n[e]);return t
    },r(i,{
    has:function(n){
        return ka+n in this
        },
...
da.ns={
        ...
        if("string"==typeof n){
            ...
            if(t=e.classList){
                for(;++i<r;)if(!t.contains(n[i]))return!1
                    }else for(t=e.getAttribute("class");++i<r;)if(!b(n[i]).test(t))return!1;return!0
            }
            for(t in n)this.each(_(t,n[t]));return this
        }
    ...
    if(3>r){
        if("string"!=typeof n){
            2>r&&(t="");
            for(e in n)this.each(S(e,n[e],t));return this
            }
    ...
    if(arguments.length<2){
        ...
        for(t in n)this.each(E(t,n[t]));return this
        }
...
Fa.on=function(n,t,e){
    ...
    if(3>r){
        if("string"!=typeof n){
            2>r&&(t=!1);
            for(e in n)this.each(D(e,n[e],t));return this
            }
...
var ho=ya[o(ya,"requestAnimationFrame")]||function(n){
    setTimeout(n,17)
    },go=".",po=",",mo=[3,3],vo="$",yo=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"].map(xt);
    ...
    function u(n){
        function u(n,t,e,r,i,u,a,o){
            if(!isNaN(e)&&!isNaN(r))if(n.leaf){
                var c=n.x,s=n.y;
                if(null!=c)if(Math.abs(c-e)+Math.abs(s-r)<.01)l(n,t,e,r,i,u,a,o);
                    else{
                    var f=n.point;
        ...
        else if(v=y=-(d=m=1/0),f=[],h=[],p=n.length,a)for(g=0;p>g;++g)s=n[g],s.x<d&&(d=s.x),s.y<m&&(m=s.y),s.x>v&&(v=s.x),s.y>y&&(y=s.y),f.push(s.x),h.push(s.y);else for(g=0;p>g;++g){
...
return o.tick=function(){
    ...
    function n(n,r){
        for(var i,u=t(e),a=-1,o=u.length;++a<o;)if(!isNaN(i=u[a][n]))return i;return Math.random()*r
        }
        function t(){
        if(!c){
            for(c=[],r=0;p>r;++r)c[r]=[];
...
da.scale.pow=function(){
    ...
    return da.scale.ordinal().range(d3_category10)
    ...
    },da.scale.category11c=function(){
    return da.scale.ordinal().range(Gc)
    },da.scale.category12=function(){
        return da.scale.ordinal().range(d3_category12)
    };

var Ec=["#1f77b4","#ff7f0e","#2ca02c","#d62728","#9467bd","#8c564b","#e377c2","#7f7f7f","#bcbd22","#17becf","#393b79","#5254a3","#6b6ecf","#9c9ede","#637939","#8ca252","#b5cf6b","#cedb9c","#8c6d31","#bd9e39","#e7ba52","#e7cb94","#843c39","#ad494a","#d6616b","#e7969c","#7b4173","#a55194","#ce6dbd","#de9ed6","#3182bd","#6baed6","#9ecae1","#c6dbef","#e6550d","#fd8d3c","#fdae6b","#fdd0a2","#31a354","#74c476","#a1d99b","#c7e9c0","#756bb1","#9e9ac8","#bcbddc","#dadaeb","#636363","#969696","#bdbdbd","#d9d9d9","#aec7e8","#ff7f0e","#ffbb78","#2ca02c","#98df8a","#d62728","#ff9896","#9467bd","#c5b0d5","#8c564b","#c49c94","#e377c2","#f7b6d2","#7f7f7f","#c7c7c7","#bcbd22","#dbdb8d","#17becf","#9edae5","#ADA96E", "#2F4F4F", "#A9A9A9", "#808000","#B0171F","#DC143C","#b8860b","#f5deb3","#9932cc","#d8bfd8","#66cdaa","#FF00FF","#357EC7", "#667c26", "#C24641","#357EC7", "#667c26", "#C24641", "#A0C544", "#53B3FF","#737CA1","#7E354D","#E66C2C","#A74AC7","#307D7E"],
//kc=["#1f77b4","#629fca","#a5c8e1","#e8f1f7","#78add2","#8fbbd9","#a5c8e1","#bbd6e8","#d2e3f0","#e8f1f7",    "#ddd",     "#c49c94","#e377c2","#f7b6d2","#7f7f7f","#c7c7c7","#bcbd22","#dbdb8d","#17becf","#9edae5"],
//kc=["#1f77b4","#aec7e8","#ff7f0e","#ffbb78","#2ca02c","#98df8a","#d62728","#ff9896","#9467bd","#c5b0d5",    "#ddd",     "#c49c94","#e377c2","#f7b6d2","#7f7f7f","#c7c7c7","#bcbd22","#dbdb8d","#17becf","#9edae5"],
Ac=["#393b79","#5254a3","#6b6ecf","#9c9ede","#637939","#8ca252","#b5cf6b","#cedb9c","#8c6d31","#bd9e39","#e7ba52","#e7cb94","#843c39","#ad494a","#d6616b","#e7969c","#7b4173","#a55194","#ce6dbd","#de9ed6"],
        ...
        Gc=["#ffffd9","#edf8b1","#c7e9b4","#7fcdbb","#41b6c4","#1d91c0","#225ea8","#253494","#081d58"],
//kc = ["#357EC7", "#667c26", "#C24641", "#A0C544", "#53B3FF","#737CA1","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
//d3_category10 = ["#357EC7", "#667c26", "#C24641", "#A0C544", "#53B3FF","#737CA1","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
//d3_category10 = ["#3366CC","#DC3912","#FF9900","#109618","#357EC7", "#667c26", "#C24641", "#A0C544", "#53B3FF","#737CA1","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
//kc = ["#222", "#333", "#444", "#555", "#666", "#777", "#888", "#999", "#aaa", "#bbb", "#ccc", "#ddd"],
//d3_category10 = ["#3366CC","#DC3912","#109618","#FF9900","#C24641", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//p5
//kc = ["#3366CC","#C03210","#23952A","#E19626","#DB1950", "#799B18", "#667c26", "#2594EC", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
// for p1
//d3_category10 = ["#084c61","#db504a","#e3b505","#4f6d7a","#C24641", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
// for p1 final
//d3_category10 = ["#084c61","#db504a","#4f6d7a","#667c26","#357EC7", "#7E354D", "#e3b505", "#2f4074", "#A0C544","#FF9900","#86652B","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//d3_category10 = ["#2b908f","#90ee7e","#f45b5b","#7798BF","#aaeeee", "#7E354D", "#e3b505", "#2f4074", "#A0C544","#FF9900","#86652B","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
// for rahul-1
//d3_category10 = ["#084C61","#843C39","#637939","#4A646C","#2E5894", "#307D7E", "#7B4173", "#D6616B", "#8C564B","#FF9900","#86652B","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//for p2
//d3_category10 = ["#247ba0","#f5b700","#dc0073","#008bf8","#70c1b3", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//kc = ["#2b908f", "#90ee7e", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee",
//      "#55BF3B", "#DF5353", "#7798BF", "#aaeeee", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//for bbraun
d3_category10 = ["#247ba0","#f5b700","#dc0073","#008bf8","#70c1b3", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//d3_category10 = ["#00B482","#33C39B","#66D2B4","#99E1CD","#7CB8A7", "#8B8B8B", "#9A9A9A", "#A5C3B9", "#000000","#3F3F3F","#FCFCFC","#D1D1D1","#000000","#7CB8A7", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
// d3_category12 = ["#3366CC","#DC3912","#109618","#FF9900","#C24641", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
 d3_category12 = ["#247ba0","#843C39","#637939","#4A646C","#2E5894", "#307D7E", "#7B4173", "#D6616B", "#8C564B","#FF9900","#86652B","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#56a3a6", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
//d3_category10 = ["#7CB8A7","#8ABCB7","#97DFCB","#BCBCBC","#D1D1D1", "#8B8B8B", "#9A9A9A", "#A5C3B9", "#000000","#3F3F3F","#FCFCFC","#D1D1D1","#000000","#7CB8A7", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//kc = ["#FF0D00","#FF7400","#FFAC07","#FFD407","#D2FC07", "#06EB06", "#06DBB7", "#262BE1", "#9511DE","#E90695","#FCFCFC","#D1D1D1","#000000","#7CB8A7", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
// kc = ["#3366CC","#DC3912","#109618","#FF9900","#C24641", "#737CA1", "#667c26", "#53B3FF", "#A0C544","#357EC7","#7E354D","#E66C2C","#A74AC7","#307D7E", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"];
 //theme color combos
// kc = ["#e0f7fa", "#b2ebf2", "#84ffff", "#80deea", "#18ffff", "#00e5ff", "#4dd0e1", "#26c6da", "#00b8d4", "#00bcd4", "#00acc1", "#0097a7","#00838f","#006064"],
// kc = ["#004d40", "#00695c ", "#00796b ", "#00897b ", "#009688 ", "#26a69a ", "#00bfa5 ", "#80cbc4 ", "#64ffda ", "#b2dfdb ", "#80deea", "#84ffff","#b2ebf2","#e0f7fa"],
 kc = ["#006064", "#00838f", "#0097a7", "#00acc1", "#00bcd4", "#00b8d4", "#26c6da", "#4dd0e1", "#00e5ff", "#18ffff", "#80deea", "#84ffff","#b2ebf2","#e0f7fa"],
// kc = ["#0d47a1", "#1565c0", "#1976d2", "#1e88e5", "#2196f3", "#42a5f5", "#64b5f6", "#90caf9", "#bbdefb", "#e3f2fd"],
// kc = ["#00CC99", "#45E36B", "#73F24C", "#99FF33", "#B8FF24", "#D1FF17", "#dce775", "#e6ee9c", "#f0f4c3", "#f9fbe7", "#aeea00", "#c6ff00"],
// kc = ["#827717", "#9e9d24", "#afb42b", "#c0ca33", "#cddc39", "#d4e157", "#dce775", "#e6ee9c", "#f0f4c3", "#f9fbe7", "#aeea00", "#c6ff00"],
// kc = ["#00FF00", "#08FF08", "#0FFF0F", "#17FF17", "#1FFF1F", "#26FF26", "#2EFF2E", "#36FF36", "#3DFF3D", "#45FF45", "#4CFF4C", "#54FF54"],
// kc = ["#0099FF", "#0099FF", "#00A3FF", "#00A8FF", "#00ADFF", "#00C2FF", "#00D6FF", "#00C7FF", "#00EBFF", "#00F5FF", "#00FAFF", "#00FFFF"],
// kc = ["#006699", "#009999", "#008C33", "#4C8033", "#339966", "#339933", "#00CC99", "#00CC66", "#33CCFF", "#3399FF", "#00FAFF", "#00FFFF"],
// kc = ["#FF9900", "#FFCC00", "#CCFF66", "#99CC00", "#6699FF", "#CCFFFF", "#3366FF", "#9900FF", "#A385FF", "#CF0DCF", "#FF3399", "#CC0029"];
// kc = ["#E6003C", "#DA0546", "#F2C70D", "#FFFF00", "#66FF33", "#009933", "#00CC99", "#0075F0", "#0014C7", "#3399FF", "#00FAFF", "#00FFFF"],
// kc = ["#0033CC", "#33CCFF", "#00FF99", "#00CC00", "#CC9900", "#CCFF33", "#CC00FF", "#FF3399", "#FF5050", "#CC0000", "#00FAFF", "#00FFFF"],
// kc = ["#7CB8A7","#8ABCB7","#97DFCB","#BCBCBC","#D1D1D1", "#8B8B8B", "#9A9A9A", "#A5C3B9", "#000000","#3F3F3F","#FCFCFC","#D1D1D1","#000000","#7CB8A7", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6","#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9","#C46210","#2E5894","#9C2542","#BF4F51","#A57164","#58427C","#4A646C","#85754E","#319177","#0A7E8C","#1f77b4", "#ff7f0e"],
//kc = ["#222", "#333", "#444", "#555", "#666", "#777", "#888", "#999", "#aaa", "#bbb", "#ccc", "#ddd"],
// end of theme color combos 
...
return this.tween("attr."+n,i.local?r:e)
    ...
    if(3>u){
        if("string"!=typeof n){
            2>u&&(t="");
            for(e in n)this.style(e,n[e],t);return this
            }
            e=""
        }
    ...
    function n(n){
        n.each(function(){
            ...
            this.__chart__=k,x.append("line"),x.append("text").attr('stroke', '#aaa');
...
da.svg.axis1 = function() {
    ...
    function axis(g) {
      g.each(function() {
        ...
        tickEnter.append("text").attr('stroke', 'grey');
        var lineEnter = tickEnter.select("line"), lineUpdate = tickUpdate.select("line"), text = tick.select("text").text(tickFormat), textEnter = tickEnter.select("text"), textUpdate = tickUpdate.select("text");

            tickTransform = d3_svg_axisX;
            subtickEnter.attr("y2", 0);
            subtickUpdate.attr("x2", 0).attr("y2", 0);
            lineEnter.attr("y2", 0);
        if (scale.rangeBand) {
...
da.svg.trendaxis=function(){
    function n(n){
        n.each(function(){
            var n,f=da.select(this),h=null==l?e.ticks?e.ticks.apply(e,c):e.domain():l,g=null==t?e.tickFormat?e.tickFormat.apply(e,c):String:t,p=Nu(e,h,s),d=f.selectAll(".tick.minor").data(p,String),m=d.enter().insert("line",".tick").attr("class","tick minor").style("opacity",1e-6),v=da.transition(d.exit()).style("opacity",1e-6).remove(),y=da.transition(d).style("opacity",1),M=f.selectAll(".tick.major").data(h,String),x=M.enter().insert("g",".domain").attr("class","tick major").style("opacity",1e-6),b=da.transition(M.exit()).style("opacity",1e-6).remove(),_=da.transition(M).style("opacity",1),w=Vi(e),S=f.selectAll(".domain").data([0]),E=(da.transition(S)),k=e.copy(),A=this.__chart__||k;
            this.__chart__=x.append("text").attr('stroke', '#aaa');
            var N=x.select("line"),q=_.select("line"),T=M.select("text").text(g),C=x.select("text"),z=_.select("text");
            switch(r){
                case"bottom":
                    n=ku,m.attr("y2",u),y.attr("x2",0).attr("y2",u),N.attr("y2",i),C.attr("y",Math.max(i,0)+o),q.attr("x2",0).attr("y2",i),z.attr("x",0).attr("y",Math.max(i,0)+o),T.attr("dy",".71em").style("text-anchor","middle"),E.attr("d","M"+w[0]+","+a+"V0H"+w[1]+"V"+a);
...
da.svg.tildaxis=function(){
    function n(n){
        n.each(function(){
            var n,f=da.select(this),h=null==l?e.ticks?e.ticks.apply(e,c):e.domain():l,g=null==t?e.tickFormat?e.tickFormat.apply(e,c):String:t,p=Nu(e,h,s),d=f.selectAll(".tick.minor").data(p,String),m=d.enter().insert("line",".tick").attr("class","tick minor").style("opacity",1e-6),v=da.transition(d.exit()).style("opacity",1e-6).remove(),y=da.transition(d).style("opacity",1),M=f.selectAll(".tick.major").data(h,String),x=M.enter().insert("g",".domain").attr("class","tick major").style("opacity",1e-6),b=da.transition(M.exit()).style("opacity",1e-6).remove(),_=da.transition(M).style("opacity",1),w=Vi(e),S=f.selectAll(".domain").data([0]),E=(da.transition(S)),k=e.copy(),A=this.__chart__||k;
            this.__chart__=x.append("text").attr('transform', 'rotate(-25)').attr('fill', '#ddd');
            var N=x.select("line"),q=_.select("line"),T=M.select("text").text(g),C=x.select("text"),z=_.select("text");
            switch(r){
                case"bottom":
                    n=ku,m.attr("y2",u),y.attr("x2",0).attr("y2",u),N.attr("y2",i),C.attr("y",Math.max(i,0)+o),q.attr("x2",0).attr("y2",i),z.attr("x",0).attr("y",Math.max(i,0)+o),T.attr("dy",".71em").style("text-anchor","middle"),E.attr("d","M"+w[0]+","+a+"V0H"+w[1]+"V"+a);
...
da.svg.brush=function(){
    function n(u){
        ...
        if(da.event.changedTouches?q.on("touchmove.brush",p).on("touchend.brush",m):q.on("mousemove.brush",p).on("mouseup.brush",m),k)N[0]=s[0][0]-N[0],N[1]=s[0][1]-N[1];
        else if(w){
